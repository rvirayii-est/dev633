...
export const RESUME_SKILLS: SkillGroup[] = [
  ...
  },
  {
    ...
    items: ['Flutter', 'Dart', 'React Native', 'Android Native', 'C#', 'Windows Desktop'],
  },
  {
    title: 'Databases',
    items: ['PostgreSQL', 'Microsoft SQL Server', 'Oracle', 'MySQL', 'MongoDB'],
  },
  {
    title: 'Cloud / DevOps',
    items: ['Docker', 'AWS', 'Cloudflare', 'CI/CD', 'Linux', 'Nginx', 'Maven', 'Tomcat', 'Git'],
  },
  {
